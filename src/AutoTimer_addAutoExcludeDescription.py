		...
		for timer in self.getEnabledTimerList():
			...
			for idx, ( serviceref, eit, name, begin, duration, shortdesc, extdesc ) in enumerate( epgmatches ):
				...
				if oldExists:
					...
					# Add excludes to autotimer to exclude following events
					#TODO Add config option addexcludes
					excludetitle, excludeshortdescription, excludedescription, excludedayofweek = timer.exclude
					#if shortdesc not in excludeshortdescription:
					#	excludeshortdescription.append(shortdesc)
					if extdesc not in excludedescription:
						excludedescription.append(extdesc)
						
					timer.exclude = (excludetitle, excludeshortdescription, excludedescription, excludedayofweek)
