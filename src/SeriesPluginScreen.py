...
class SeriesPluginInfoScreen(Screen):
	...
	skinfile = "/usr/lib/enigma2/python/Plugins/Extensions/SeriesPlugin/skin.xml" 
	...
	def getEpisode(self):
		...
		#		self["key_green"].setText(_("Add timer"))
			...
			begin = info and info.getInfo(ref, iServiceInformation.sTimeCreate) or 0
			end = info and begin + (info.getLength(ref) or 0) or 0
