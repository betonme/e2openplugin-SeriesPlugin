...
config.plugins.seriesplugin.menu_event_info           = ConfigYesNo(default = True)
...
url_choices = [	
					( "http://www.serienserver.de/cache/cache.php", "Stable" ),
					( "http://www.serienserver.de/test/cache.php", "Experimental" )
				]
